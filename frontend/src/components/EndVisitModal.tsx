...
export default function EndVisitModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative z-10 mx-4 w-full max-w-md rounded-2xl bg-white dark:bg-slate-800 shadow-2xl">
        {/* Header */}
        <div className="border-b border-slate-100 dark:border-slate-700 px-6 pt-6 pb-4">
          <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-red-50 dark:bg-red-900/30">
            <svg
        ...
        <div className="px-6 py-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <SummaryItem label="Audio Segments Processed" value={String(chunksProcessed)} />
        ...
        <div className="flex gap-3 border-t border-slate-100 dark:border-slate-700 px-6 py-4">
          <button
            onClick={onCancel}
            disabled={isLoading}
            className="flex-1 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 transition-colors hover:bg-slate-50 dark:bg-slate-900 disabled:opacity-50"
          >
            Continue Recording
          </button>
          <button
