    ...
    <div className="card">
      ...
      <div className="flex items-center justify-between">
        <h3 className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
          ...
          Follow-ups
          {followUps.length > 0 && (
            <span className="ml-1 inline-flex h-5 min-w-[1.25rem] items-center justify-center rounded-full bg-teal-100 dark:bg-teal-900/30 px-1.5 text-[10px] font-bold text-teal-700 dark:text-teal-300">
              {followUps.length}
            </span>
          )}
        </h3>
      ...
      {/* Saving indicator */}
      {saving && (
        <div className="mt-2 text-[11px] text-slate-400 dark:text-slate-500 flex items-center gap-1">
          <svg className="h-3 w-3 animate-spin" viewBox="0 0 24 24" fill="none">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
          </svg>
      ...
      {/* Add new item */}
      {adding ? (
        <div className="mt-3 rounded-lg border border-dashed border-teal-300 dark:border-teal-700 bg-teal-50 dark:bg-teal-900/30/30 p-3 space-y-2">
          <div>
            ...
            <input
              ...
              className="w-full rounded border border-slate-300 dark:border-slate-600 px-2 py-1 text-sm focus:border-teal-400 focus:outline-none focus:ring-1 focus:ring-teal-400"
              autoFocus
            />
          </div>
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-1 rounded-lg border border-dashed border-slate-300 dark:border-slate-600 py-2 text-xs text-slate-400 dark:text-slate-500 transition-colors hover:border-teal-400 hover:text-teal-600"
        >
