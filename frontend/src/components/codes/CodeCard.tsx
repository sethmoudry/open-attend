...
const CodeCard: React.FC<CodeCardProps> = ({ code, onToggleConfirm }) => {
  const borderClass = code.confirmed
    ? "border-emerald-600 bg-gray-900/80"
    : "border-dashed border-gray-600 bg-gray-900/40";
  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="mt-1 h-4 w-4 shrink-0 cursor-pointer rounded border-gray-500 bg-gray-800 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-0"
      />
