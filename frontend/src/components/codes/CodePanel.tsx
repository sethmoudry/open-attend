...
const CodePanel: React.FC<CodePanelProps> = ({
  ...
  return (
    <div
      className={`flex flex-col rounded-2xl bg-gray-900 shadow-lg ${className}`}
    >
      {/* Header */}
      ...
      {/* Footer actions */}
      {hasCodes && !loading && (
        <div className="flex items-center gap-2 border-t border-gray-800 px-5 py-3">
          <button
            onClick={handleExtract}
          ...
          <button
            ...
            className="rounded-lg border border-red-800 px-3 py-1.5 text-xs text-red-400 transition-colors hover:border-red-600 hover:text-red-300"
          >
            Remove Unchecked
          </button>
        </div>
