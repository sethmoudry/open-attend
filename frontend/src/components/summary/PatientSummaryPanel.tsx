  ...
  if (previewMode && summary) {
    return (
      <div className="card">
        ...
        <div
          ref={printRef}
          className="mx-auto max-w-lg rounded-xl border-2 border-slate-200 bg-white p-8 shadow-sm"
        >
          {/* Clinic header */}
          <div className="border-b border-slate-200 pb-4 mb-6 text-center">
            <h1 className="text-xl font-bold text-slate-800">Your Visit Summary</h1>
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2">
                {editMeds.map((med, i) => (
                  <li
                    key={i}
                    className="flex items-start gap-2 rounded-lg bg-orange-50 p-3 text-base text-slate-700"
                  >
            ...
            <div className="mb-6">
              ...
              <ol className="space-y-2">
                {editSteps.map((step, i) => (
                  <li
                    key={i}
                    className="flex items-start gap-3 rounded-lg bg-blue-50 p-3 text-base text-slate-700"
                  >
                    <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-blue-200 text-xs font-bold text-blue-700">
                      {i + 1}
                    </span>
                    {step}
                  </li>
          ...
          {editSeekCare && (
            <div className="rounded-lg border-2 border-red-200 bg-red-50 p-4">
              <h2 className="mb-2 flex items-center gap-2 text-base font-bold text-red-700">
    ...
    <div className="card">
      ...
      {summary && (
        <div className="mt-2 flex items-center gap-1.5">
          <span className="text-[10px] text-slate-400">Reading level:</span>
        ...
        <div className="mt-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm leading-relaxed text-slate-700 focus:border-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-400"
            />
          </div>
              ...
              {editMeds.map((med, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 rounded border border-slate-300 px-2 py-1 text-sm focus:border-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-400"
                  />
                  <button
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-lg border border-red-200 bg-red-50/30 px-3 py-2 text-sm leading-relaxed text-slate-700 focus:border-red-400 focus:outline-none focus:ring-1 focus:ring-red-400"
