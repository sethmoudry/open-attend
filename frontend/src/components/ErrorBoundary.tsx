...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    if (this.props.inline) {
      return (
        <div className="rounded-lg border border-amber-200 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/30 p-4 text-center">
          ...
          <button
            ...
            className="mt-3 rounded-md bg-amber-100 dark:bg-amber-900/30 px-3 py-1.5 text-xs font-medium text-amber-800 dark:text-amber-200 transition-colors hover:bg-amber-200"
          >
            Try Again
          </button>
        </div>
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-900 px-6">
        <div className="w-full max-w-md text-center">
          ...
          <p className="mb-6 text-xs font-mono text-slate-400 dark:text-slate-500">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <a
              href="/"
              className="rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 transition-colors hover:bg-slate-50 dark:bg-slate-900"
            >
              Return Home
            </a>
          </div>
