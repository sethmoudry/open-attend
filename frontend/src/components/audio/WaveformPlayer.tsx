...
export default function WaveformPlayer({
  ...
  return (
    <div className="border-b border-slate-200 bg-white" ref={containerRef}>
      {audioBlobUrl && (
      ...
      <div className="flex items-center gap-3 px-4 py-2">
        ...
        <div className="relative min-w-0 flex-1">
          <canvas
            ref={canvasRef}
            className="h-10 w-full cursor-crosshair rounded"
      ...
      {/* Selection info bar */}
      {hasSelection && (
        <div className="flex items-center gap-2 border-t border-slate-100 bg-blue-50 px-4 py-1.5">
