            ...
            medications.map((med, idx) => {
              ...
              return (
                <div
                  ...
                  className={`rounded-lg border p-2.5 text-xs ${hasWarning ? "border-warning-500 bg-warning-50" : "border-slate-200 bg-white"}`}
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`rounded-full px-2 py-0.5 text-[10px] font-medium ${med.source === "prescribed" ? "bg-clinical-100 text-clinical-700" : "bg-slate-100 text-slate-600"}`}
                    >
