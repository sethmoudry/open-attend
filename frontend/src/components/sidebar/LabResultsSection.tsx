    ...
    <div className="card">
      ...
      {!collapsed && (
        <div className="mt-3 space-y-3">
          {labReports.length === 0 ? (
            <p className="text-xs text-slate-400 dark:text-slate-500">No lab reports uploaded</p>
          ) : (
            labReports.map((report) => (
              ...
              >
                {/* Report header */}
                <div className="border-b border-slate-100 dark:border-slate-700 px-2.5 py-2">
                ...
                {report.results.length > 0 && (
                  <div className="overflow-x-auto">
                    <table className="w-full text-[11px]">
                      <thead>
                        <tr className="border-b border-slate-100 dark:border-slate-700 text-left text-[10px] font-medium uppercase tracking-wider text-slate-400 dark:text-slate-500">
                      ...
                      <tbody>
                        {report.results.map((result, idx) => {
                          ...
                          return (
                            ...
                            >
                              <td className="px-2.5 py-1.5 font-medium text-slate-700 dark:text-slate-300">
                                {result.test}
                              </td>
                              <td
