...
const FLAG_STYLES: Record<string, string> = {
  ...
  critical: "bg-red-200 text-red-800 dark:text-red-200 font-bold",
};
            ...
            {uploading ? (
              <>
                {previewUrl ? (
                  ...
                  <div className="flex h-12 w-12 items-center justify-center rounded bg-slate-200 dark:bg-slate-700">
                    <svg
                  ...
                  <div className="mt-2 border-t border-slate-100 dark:border-slate-700 pt-2">
                    ...
                    <div className="space-y-1">
                      {report.results.map((result, idx) => (
                        ...
                        >
                          <span className="text-slate-600 dark:text-slate-300">{result.test}</span>
                    ...
                    {report.results.some((r) => r.reference_range) && (
                      <div className="mt-1.5 space-y-0.5">
                        {report.results
                          ...
                          .map((r, idx) => (
                            <p key={idx} className="text-[10px] text-slate-400 dark:text-slate-500">
