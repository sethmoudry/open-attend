...
TRANOPENATTEND_MODEL = os.getenv("TRANOPENATTEND_MODEL", "google/medasr")
...
def _load_pipeline():
    ...
    model_name = TRANOPENATTEND_MODEL
...
WHISPER_INITIAL_PROMPT = (
    ...
    "Terminology: hypertension, hyperlipidemia, diabetes mellitus, metformin, lisinopril, "
    "atorvastatin, omeprazole, amlodipine, levothyroxine, albuterol, prednisone, "
    "gabapentin, sertraline, hydrochlorothiazide, losartan, warfarin, amoxicillin, "
    "ibuprofen, acetaminophen, sumatriptan, topiramate, "
    "echocardiogram, colonoscopy, MRI, CT scan, CBC, BMP, CMP, HbA1c, TSH, lipid panel, "
    "bilateral, contralateral, ipsilateral, anterior, posterior, proximal, distal, "
    "auscultation, palpation, percussion, tachycardia, bradycardia, dyspnea, "
    "edema, effusion, stenosis, murmur, wheezing, rhonchi, rales, "
    "HEENT, PERRL, normocephalic, atraumatic."
)
