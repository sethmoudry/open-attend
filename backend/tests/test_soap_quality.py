...
async def test_full_visit_soap_generation():
    ...
    with patch("llm.call_medgemma_json", new=mock_fn), \
             patch("tools.call_medgemma_json", new=mock_fn), \
...
async def test_patient_speech_never_in_objective():
    ...
    with patch("llm.call_medgemma_json", new=_dispatch), \
         patch("tools.call_medgemma_json", new=_dispatch), \
