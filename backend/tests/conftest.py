"""Shared fixtures for Open Attend backend tests."""
...
def mock_llm():
    ...
    with (
        ...
        patch("tools.medications.call_medgemma_json", mock_json),
        patch("tools.diagnosis.call_medgemma_json", mock_json),
        patch("tools.soap.call_medgemma_json", mock_json),
        patch("tools.coding.call_medgemma_json", mock_json),
        patch("tools.alerts.call_medgemma_json", mock_json),
        patch("tools.orders.call_medgemma_json", mock_json),
        patch("tools.patient.call_medgemma_json", mock_json),
