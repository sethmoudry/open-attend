#!/usr/bin/env bash
# Open Attend — vast.ai instance setup script
...
#!/usr/bin/env bash
# Start Open Attend backend pointing at local vLLM
set -euo pipefail
...
cd /root/backend
echo "Starting Open Attend backend on port 8080..."
...
echo "    8080 — Open Attend backend API"
